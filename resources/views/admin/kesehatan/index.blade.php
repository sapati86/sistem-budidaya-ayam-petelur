...
@section('header', 'Manajemen Kesehatan Ayam')

@section('content')
<div class="bg-white rounded-lg shadow p-6">
    <div class="flex justify-between items-center mb-4">
        <h3 class="text-lg font-semibold">Daftar Data Kesehatan</h3>
        <a href="{{ route('admin.kesehatan.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
    ...
    <div class="overflow-x-auto">
        <table class="w-full">
            ...
            <tbody>
                ...
                <tr class="border-t">
                    <td class="px-4 py-2">{{ $kesehatan->tanggal?? '-'}}</td>
                    ...
                    <td class="px-4 py-2">
                        <a href="{{ route('admin.kesehatan.show', $kesehatan) }}" class="text-blue-500 hover:text-blue-700 mr-2">
                            <i class="fas fa-eye"></i>
                        </a>
                        <a href="{{ route('admin.kesehatan.edit', $kesehatan) }}" class="text-yellow-500 hover:text-yellow-700 mr-2">
                            <i class="fas fa-edit"></i>
                        </a>
                        <form action="{{ route('admin.kesehatan.destroy', $kesehatan) }}" method="POST" class="inline">
                            @csrf
                            @method('DELETE')
